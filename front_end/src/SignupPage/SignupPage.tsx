  ...
  useEffect(() => {
    const unsubscribe = onAuthStateChanged(auth, user => {
      if (user) {
        ...
        const dateObject =
          new Date(user.metadata.creationTime?.toString()!).getTime() / 1000;
    ...
    <div className={styles.app}>
      ...
      <div className={styles.mainContainer}>
          ...
          <div className={styles.subContainer}>
            <div className={styles.subSubContainer}>
              ...
              <p className={styles.subTitle}>
                You can sign in{' '}
                <Link to={'/login'} className={styles.specialColour}>
                  {' '}
                  here !
                </Link>
              </p>
            ...
            <img
              src="https://i.ibb.co/4FWS973/Saly-14.png"
        ...
        <div className={styles.signUpContainer}>
          ...
          <h1 className={styles.signupErrorMessageTitle}>
            {signupErrorMessage}
          </h1>
